...
*
*/
define('APP_BASE_URL', 'https://inter.graphics/perfex/perfex_crm/');
...
*/
define('APP_ENC_KEY', 'c9d30e9df6aa31d41a653fdca99ddd30');
 ...
 */
define('APP_DB_USERNAME', 'inter_perfex-user');

/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', '100%Perfex007');

/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'inter_perfex-db');
